...
As mentioned above, this is a simple program that will allow you to stitch the images selected and make a collage. It uses the Python Imaging Library (PIL) to help resizing and combining the images.
